...
&nbsp <button type="button" class="btn btn-success"><a href="addcustomer" style="text-decoration:none;color:white"><spring:message code="makerpage.addcustomer.button" text="Add Customer"/></a></button>

<button type="button" class="btn btn-danger"><a href="/CustMgmtApp/logout" style="text-decoration:none;color:white"><spring:message code="makerpage.logout.button" text="Log Out"/></a></button>
  ...
  <thead>
    ...
    <c:forEach items="${customers}" var="customer">
        <tr>
            ...
            <td>
            <button type="button" class="btn btn-info btn-sm" ><a href="view?id=${customer.customerCode}&status=${customer.recordStatus}" class="delete" style="text-decoration:none;color:white"><spring:message code="makerpage.view.button" text="view"/></a></button>

            <button type="button" class="btn btn-primary btn-sm"><a href="update?id=${customer.customerCode}&status=${customer.recordStatus}" class="delete"  style="text-decoration:none;color:white"><spring:message code="makerpage.update.button" text="update"/></a></button>
            <button type="button" class="btn btn-danger btn-sm"><a href="delete?id=${customer.customerCode}&status=${customer.recordStatus}" class="delete" style="text-decoration:none;color:white"><spring:message code="makerpage.delete.button" text="delete"/></a></button>
            </td>
        </tr>
    </c:forEach>
    </tbody>
