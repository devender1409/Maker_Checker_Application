...
@Entity
@Table(name = "customer_temp_16794")
public class CustomerTempEntity {
    ...
    public boolean equals(Object o) {
        ...
        CustomerTempEntity that = (CustomerTempEntity) o;
    ...
    public CustomerTempEntity(Integer customerId, String customerCode, String customerName, String customerAddress1, int customerPinCode, String emailAddress, String primaryContactPerson, String recordStatus, String activeInactiveFlag, String createdBy, Date createdDate) {
        this.customerId = customerId;
        this.customerCode = customerCode;
        this.customerName = customerName;
        this.customerAddress1 = customerAddress1;
