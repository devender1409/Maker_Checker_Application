...
public class CustomerFormBeanToCustomerMstEntity {
    public static CustomerMstEntity parse(CustomerFormBean customerFormBean){
        CustomerMstEntity customer = new CustomerMstEntity();
